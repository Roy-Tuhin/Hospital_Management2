                                        ...
                                        <div class="contact-body">
                                            ...
                                            <form  method="post" action="Login">
                                                ...
                                                <div class="inputGroup inputGroup1 col-12 col-md-6 col-lg-6">
                                                    ...
                                                    <input name="email" type="text" id="loginEmail" maxlength="254" class="form-control" placeholder="Email" />
                                                ...
                                                <div class="inputGroup inputGroup2 col-12 col-md-6 col-lg-6">
                                                    ...
                                                    <input name="password" class="form-control" type="password" id="loginPassword" placeholder="Password" />
